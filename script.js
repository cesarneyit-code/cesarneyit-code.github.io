const translations = {
  es: {
    ...
    research: {
      title: "Investigación",
      intro: "Líneas principales de trabajo actual.",
      r1t: "Categorías Tensoriales y de Fusión",
      r1d: "Problemas de estructura y clasificación en categorías de fusión y categorías trenzadas, incluyendo contextos débilmente integrales y super-modulares.",
      r2t: "Teoría Topológica Cuántica de Campos",
      r2d: "Datos modulares, simetrías categóricas y construcciones relacionadas con fases topológicas y teorías topológicas cuánticas de campos.",
      r3t: "Conexiones con Computación Cuántica",
      r3d: "Aplicaciones de métodos categóricos y algebraicos a información cuántica, incluyendo representaciones de trenzas y contextos de corrección de errores cuánticos."
    },
    teaching: {
      title: "Docencia",
      currentTitle: "Cursos recientes en Uniandes",
      current1: "Cálculo Vectorial (2022-I, pregrado)",
      current2: "Cálculo Diferencial (2021-I, pregrado)",
      pastTitle: "Cursos anteriores seleccionados",
    ...
    pub: {
      ...
      intro: "Una lista corta curada. Para la lista completa, ver Google Scholar y ORCID.",
  ...
  en: {
    ...
    research: {
      title: "Research",
      intro: "Main directions of my current work.",
      r1t: "Tensor and Fusion Categories",
      r1d: "Structure and classification problems in fusion and braided fusion categories, including weakly integral and super-modular settings.",
      r2t: "Topological Quantum Field Theory",
      r2d: "Modular data, categorical symmetries, and constructions related to topological phases and topological quantum field theories.",
      r3t: "Quantum Computation Connections",
      r3d: "Applications of categorical and algebraic methods to quantum information, including braid representations and quantum error correction contexts."
    },
    teaching: {
      title: "Teaching",
      currentTitle: "Recent Courses at Uniandes",
      current1: "Vector Calculus (2022-I, Undergraduate)",
      current2: "Differential Calculus (2021-I, Undergraduate)",
      pastTitle: "Selected Previous Courses",
    ...
    pub: {
      ...
      intro: "A short curated list. For the complete list, see Google Scholar and ORCID.",
